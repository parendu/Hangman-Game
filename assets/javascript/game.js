 (function() {
     "use strict";
     var availableLetters, songs, guessInput, guess, lettersGuessed, lettersMatched, output, man, letters, tries, currentSinger, numLettersMatched, messages, wins, losses;
     ...
     function setup() {
         ...
         losses = 0;
         songs = [{
                 filename: "./assets/media/Consideration_Rihanna.mp3",
                 singer: "rihanna",
                 album: "Album_nice"
             }, {
                 filename: "./assets/media/Just_Dance_Ladygaga.mp3",
                 singer: "ladygaga",
                 album: "Album_latest"
             }, {
                 filename: "./assets/media/Love_Story_Taylor_Swift.mp3",
                 singer: "taylor swift",
                 album: "Album_new"
             }, {
                 filename: "./assets/media/Sober_Selena_Gomez.mp3",
                 singer: "selena gomez",
                 album: "Album_old"
             }, {
                 filename: "./assets/media/Sorry_Bieber.mp3",
                 singer: "justin bieber",
                 album: "Album_old"
             }, {
                 filename: "./assets/media/This_is_Me_Demi_Lovato.mp3",
                 singer: "demi lovato",
                 album: "Album_old"
             }
         ...
         // document.querySelector("mysource").src = song.filename;
         document.getElementById("mysource").src = song.filename;

         console.log("current filename: " + song.filename);
     ...
     function startOver() {
         ...
         var song = songs[randomIndex];
         document.querySelector("mysource").src = song.filename;
         console.log("current filenane: " + song.filename);
         ...
         man.innerHTML = 'You have ' + tries + ' chances remaining';
         output.innerHTML = '';
